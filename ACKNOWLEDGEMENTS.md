...
Este projeto foi desenvolvido com o propósito de facilitar a rotina de estudantes e praticar o desenvolvimento de software. Abaixo estão listadas as inspirações, ferramentas e tecnologias que tornaram o projeto possível.

## Inspiração
* **[CS50 check50](https://cs50.readthedocs.io/projects/check50/en/latest/)**: O conceito e o funcionamento central desta ferramenta foram fortemente inspirados no corretor automatizado do curso CS50 da Universidade de Harvard.
